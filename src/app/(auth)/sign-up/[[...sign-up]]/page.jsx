...
import { Sparkles, GitBranch, Eye } from "lucide-react";
        ...
        <div className="hidden lg:flex lg:col-span-7 flex-col justify-between p-12 border-r border-border bg-muted/20 dark:bg-neutral-950/40 backdrop-blur-md">
          ...
          <div className="max-w-2xl space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-xs font-semibold text-orange-500 dark:text-orange-400">
              ...
              <span>AI Powered GitHub Documentation</span>
            </div>

            <h1 className="text-4xl sm:text-5xl font-black tracking-tight leading-[1.1] text-foreground dark:text-white">
              Automate your codebase documentation in{" "}
              <span className="bg-gradient-to-r from-orange-400 via-orange-500 to-amber-700 dark:from-orange-300 dark:via-orange-500 dark:to-orange-900 bg-clip-text text-transparent">
                seconds.
              </span>
            </h1>

            <p className="text-md max-w-xl text-muted-foreground dark:text-neutral-400 leading-relaxed">
              Join thousands of developers turning messy repositories into
              production-ready README files with deep AI structural inspection.
            </p>

            {/* Feature Pills */}
            <div className="pt-4 flex flex-wrap gap-3">
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-muted/60 dark:bg-neutral-900 border border-border dark:border-neutral-800 text-xs font-medium text-foreground/80 dark:text-neutral-300">
                <GitBranch className="w-4 h-4 text-orange-500 dark:text-orange-400" />
                <span>Direct Repository Commit</span>
              </div>
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-muted/60 dark:bg-neutral-900 border border-border dark:border-neutral-800 text-xs font-medium text-foreground/80 dark:text-neutral-300">
            ...
            <SignUp
              appearance={{
                elements: {
                  ...
                  // Typography
                  headerTitle:
                    "text-foreground dark:text-white font-black text-2xl tracking-tight",
                  headerSubtitle:
                    "text-muted-foreground dark:text-neutral-400 text-xs mt-1",
                  ...
                  footerActionText:
                    "text-muted-foreground dark:text-neutral-400 text-xs",
                  identityPreviewText:
